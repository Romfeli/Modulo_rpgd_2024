...
<div>
  ...
  <div class="flex justify-center items-center mx-4 my-4">
    <div class="w-full sm:w-2/3 lg:w-96  bg-white p-6 rounded-lg shadow-lg">
   ...
   @if($successMessage)
<div class="flex justify-center items-center mt-4 p-2 sm:p-4">
  <div class="w-full sm:w-96 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
